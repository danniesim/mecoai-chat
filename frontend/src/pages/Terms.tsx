...
const Terms = () => {
  return (
    ...
    <DialogSurface style={{ overflow: "auto" }}>
      ...
      <DialogContent>
        <p>
          By accessing the website at mecorocketscientist.com, you are agreeing
        ...
        <ol type="a">
          ...
          <li>
            ...
            these restrictions and may be terminated by MecoAI at any time. Upon
        ...
        <ol type="a">
          <li>
            The materials on MecoAI's website are provided on an 'as is' basis.
            MecoAI makes no warranties, expressed or implied, and hereby
        ...
        <p>
          ...
          use the materials on MecoAI's website, even if MecoAI or a MecoAI
        ...
        <p>
          ...
          MecoAI may make changes to the materials contained on its website at
          any time without notice. However MecoAI does not make any commitment
          to update the materials.
        </p>
        <h2>Links</h2>
        <p>
          MecoAI has not reviewed all of the sites linked to its website and is
