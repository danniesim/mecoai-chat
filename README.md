...
|UI_TITLE|MecoAI| Chat title (left-top) and page title (HTML)
|UI_LOGO|| Logo (left-top). Defaults to MecoAI logo. Configure the URL to your logo image to modify.
|UI_CHAT_LOGO|| Logo (chat window). Defaults to MecoAI logo. Configure the URL to your logo image to modify.
...
|UI_FAVICON|| Defaults to MecoAI favicon. Configure the URL to your favicon to modify.
